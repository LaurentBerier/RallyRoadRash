/* ============================================================
   ...
   floor at s=1125 (-32.9 m), and the biggest kickers in the game:
   3.3-3.6 m lips off 14-16 m ramps, which is ~34 m of air and 3+ m of
   height at racing speed.

     s  380- 560  lava runs in a channel to the LEFT of the line, close
                  enough to light the bodywork
     s  600- 760  the descent, two kickers back to back — the second
                  launches you over a 12 m fissure with lava in it
...
export default {
  ...
  path: [
    { x: 293.7, z: 0, y: -5.2, w: 9 }, { x: 291.2, z: 55.4, y: 2.5, w: 8.9 }, { x: 284.6, z: 110.4, y: 10, w: 8.7 },
    { x: 270.6, z: 163.9, y: 16.6, w: 8.6 }, { x: 247.2, z: 214.1, y: 21.8, w: 8.4 }, { x: 212.9, z: 257.4, y: 25.6, w: 8.2 },
    { x: 168.9, z: 290.8, y: 28.2, w: 8.1 }, { x: 117.6, z: 311.2, y: 29.9, w: 7.9 }, { x: 62.5, z: 316.1, y: 31, w: 7.8 },
    { x: 8, z: 307.4, y: 31.5, w: 7.6 }, { x: -42.8, z: 285.3, y: 31.2, w: 7.5 }, { x: -87.7, z: 253, y: 29.7, w: 7.4 },
  ...
  paints: [
    ...
    { s0: 744, s1: 759, type: SURF.LAVA, lat0: -22, lat1: 22 },
  ...
  jumps: [
    { s: 255, len: 14, h: 2.8 },
    { s: 615, len: 15, h: 3.4 },
    { s: 745, len: 16, h: 3.6, gap: 12 },        // over the fissure
    { s: 1795, len: 15, h: 3.3 }
  ],
