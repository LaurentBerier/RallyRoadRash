...
j.asset.extras={...j.asset.extras,ironhideImport:{removedLauncherTriangles:removed,cutHeight:.245}};
...
writeFileSync('assets/models/ridgeback-ironhide.glb',out);console.log({removed,triangles:kept.length/3});
